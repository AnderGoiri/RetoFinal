...
public class ManagerInsertProductPanel extends JPanel implements ActionListener, KeyListener, FocusListener {
	...
	/*
	 * private boolean blankText() { boolean thereIsBlankText=false; String
	 * blankSpaceComponents="";
	 * 
	 * for(Component c : this.getComponents()) { if(c.isEnabled()) { if(c instanceof
	 * JTextField) { if(((JTextField)c).getText().isBlank()) {
	 * if(blankSpaceComponents.equals("")) { blankSpaceComponents+=c.getName();
	 * }else { blankSpaceComponents+=", "+c.getName(); } }
	 * 
	 ...
	 * }else { blankSpaceComponents+=", "+c.getName(); } }
	 * 
	 * }else if(c instanceof JTextArea) { if(((JTextArea)c).getText().isBlank()) {
	 * if(blankSpaceComponents.equals("")) { blankSpaceComponents+=c.getName();
	 * }else { blankSpaceComponents+=", "+c.getName(); } } }
	 * 
	 * }
	 ...
	 * if(blankSpaceComponents.equals("")) { blankSpaceComponents+="Product Type";
	 * }else { blankSpaceComponents+=", Product Type"; } }
	 * 
	 * if(!blankSpaceComponents.equals("")) { thereIsBlankText=true;
	 * 
	 * JOptionPane.showMessageDialog(this,
	 * "Hay campos obligatorios que estan vacios. Estos son:\n"
